    ...
    Row{
        ...
        Image {
            ...
            MouseArea{
                anchors.fill: parent
                onClicked: {
                    im2.visible = Qt.binding(function() {
                        return (im2.visible === isvisible) ? !isvisible : isvisible;
                    });

                    im3.visible = Qt.binding(function() {
                        return (im3.visible === isvisible) ? !isvisible : isvisible;
                    });

                    im4.visible = Qt.binding(function() {
                        return (im4.visible === isvisible) ? !isvisible : isvisible;
                    });

                    im1.visible=isvisible;
                }
            }
        ...
        Image {
            ...
            MouseArea{
                anchors.fill: parent
                onClicked: {
                    im1.visible = Qt.binding(function() {
                        return (im1.visible === isvisible) ? !isvisible : isvisible;
                    });
